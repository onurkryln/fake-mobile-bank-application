  ...
  SignIn() {
    ...
    return Column(
      ...
      children: [
        ...
        Container(child: ElevatedButton(style: ButtonStyle(side: MaterialStatePropertyAll(BorderSide.none),backgroundColor: MaterialStatePropertyAll(Colors.cyanAccent)),onPressed: () => Navigator.pop(context), child: Text("Çıkış",style: TextStyle(fontSize: 17,color: Colors.blueGrey),))),
 ...
 Widget  Myimage() {
    List <ListTile>liste=[
      ...
      ListTile(
        ...
        onTap: () {
          setState(() {
            Navigator.push(context, MaterialPageRoute(builder: (context) => Scaffold(appBar: AppBar(title:Text("Kayıt olun")),body: SignIn(),)));
